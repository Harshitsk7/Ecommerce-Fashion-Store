	...
	return (
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			<div className="m-4 sm:m-6 flex-1">
				<h2 className="text-4xl text-center md:text-left mb-4">CARGEN</h2>
				<p className="text-justify text-gray-700">Cargen is a fashion powerhouse known for its cutting-edge designs, where urban style meets sustainability. Their collections feature high-quality, eco-conscious pieces, making them a go-to choice for the fashion-forward and environmentally-conscious consumer. Elevate your wardrobe with Cargen's chic and responsible fashion offerings..</p>
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					<li className="flex items-center">
						...
						<span>RPD, Belgaum</span>
					</li>					
					<li className="flex items-center">
						<Phone className="w-5 h-5 mr-2" />
						<span>+91 987 654 3654</span>
					</li>					
					<li className="flex items-center">
						<Mail className="w-5 h-5 mr-2" />
						<a href="mailto:cargen@gmail.com" target="_blank">
							cargen@gmail.com
						</a>
					</li>
					<li className="flex items-center">
